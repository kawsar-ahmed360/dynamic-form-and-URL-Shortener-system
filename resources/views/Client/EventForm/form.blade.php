  ...
  <form action="{{route('EventRegistrationSubmit')}}" method="post">
   ...
   <div class="row">
      ...
      @if(@$dy->status=='Radio Group With Amount')
       ...
       @endphp
        ...
        <div class="col-md-12">
               ...
               <div class="form-check">
                ...
                <!-- <input type="text" name="{{@$dy->field_value}}" id="radio_group_val{{@$name->id}}"> -->
                @endforeach
       ...
       @endphp
        ...
        <div class="col-md-12">
             ...
             <h5>{{@$dy->field_name}}</h5>
               ...
               <div class="form-check">
                <label class="form-check-label">
                    <input type="radio"   name="{{@$dy->field_value}}" value="{{@$name->radio_field_name}} " class="form-check-input" >{{@$name->radio_field_name}} 
                </label>
                </div>
                @endforeach
        ...
        <!-- <h5>DrowpDown Select Option</h5> -->
            ...
            <select name="{{@$dy->field_value}}" class="form-control" id="">
       ...
       <div class="col-md-6">
           <div class="form-group">
            <label for="usr">{{@$dy->field_name}}:</label>
            <input type="text" class="form-control" name="{{@$dy->field_value}}" placeholder="{{@$dy->field_name}}">
            </div>
        </div>
    ...
    <div class="col-md-12">
            ...
            <div class="custom-control custom-checkbox">
                <input type="text" id="total_amount_val" name="total_amount_val" class="form-control" >
