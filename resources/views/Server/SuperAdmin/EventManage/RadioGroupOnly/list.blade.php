...
@section('title') Radio Group Only Create @endsection
@section('content')
...
<div class="br-section-wrapper">
    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="margin-bottom: 40px;">{{@$event_name->event_name}} {{@$dynamic_field->field_name}} Radio Group WithOut Amount Field List <a data-toggle="modal" data-target="#modaldemo1" class="pull-right btn btn-outline-primary btn-sm mg-b-10">Field Create</a></h6>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td>
                          ...
                          <a data-toggle="modal" data-target="#modaldemoedit{{@$value->id}}" class="btn btn-outline-info btn-sm m_hov"><i id="hov" class="fa fa-edit"></i></a>
                           <a id="delete" href="{{route('DynamicFieldRadioGroupOnlyDelete',@$value->id)}}" class="btn btn-outline-danger btn-sm m_hov"><i id="hov" class="fa fa-trash"></i></a>
  ...
  <div id="modaldemoedit{{@$value->id}}" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center" role="document">
              <div class="modal-content bd-0 tx-14" style="width:540px">
                ...
                <form action="{{route('DynamicFieldRadioGroupOnlyUpdate')}}" method="post">
                    @csrf
  ...
  <div id="modaldemo1" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center" role="document">
              <div class="modal-content bd-0 tx-14" style="width:540px">
                ...
                <form action="{{route('DynamicFieldRadioGrouOnlytStore')}}" method="post">
                    @csrf
