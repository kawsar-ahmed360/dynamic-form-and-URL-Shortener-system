...
@section('title') Select Option Create @endsection
@section('content')
...
<div class="br-section-wrapper">
    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="margin-bottom: 40px;">{{@$event_name->event_name}} {{@$dynamic_field->field_name}} Select Option Field List <a data-toggle="modal" data-target="#modaldemo1" class="pull-right btn btn-outline-primary btn-sm mg-b-10">Field Create</a></h6>
            ...
            <table id="example" class="table display responsive nowrap dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable1_info" style="width: 942px;">
                <thead>
                    <tr role="row">
                        ...
                        <th class="wd-15p sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" style="width: 115px;" aria-label="Last name: activate to sort column ascending">Option Name</th>
                ...
                <tbody>
                   ...
                   @foreach(@$list as $key => $value)
                    ...
                    <tr role="row" class="odd">
                        ...
                        <!-- <td>{{ $value->radio_field_amount }}</td> -->
                        ...
                        <td>
                          ...
                          <a data-toggle="modal" data-target="#modaldemoedit{{@$value->id}}" class="btn btn-outline-info btn-sm m_hov"><i id="hov" class="fa fa-edit"></i></a>
                           <a id="delete" href="{{route('DynamicFieldSelectOptionDrowpdownDelete',@$value->id)}}" class="btn btn-outline-danger btn-sm m_hov"><i id="hov" class="fa fa-trash"></i></a>
            ...
            <div class="modal-dialog modal-dialog-vertical-center" role="document">
              <div class="modal-content bd-0 tx-14" style="width:540px">
                <div class="modal-header pd-y-20 pd-x-25">
                  <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Select Option Value Edit</h6>
                ...
                <form action="{{route('DynamicFieldSelectOptionDrowpdownUpdate')}}" method="post">
                    @csrf
                  ...
                  <input type="hidden" name="edit_id" value="{{@$value->id}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="option_value" value="{{@$value->option_value}}" placeholder="Enter Option Name">
                        </div>
  ...
  <div id="modaldemo1" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center" role="document">
              <div class="modal-content bd-0 tx-14" style="width:540px">
                <div class="modal-header pd-y-20 pd-x-25">
                  <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Select Option Value Add</h6>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <form action="{{route('DynamicFieldSelectOptionDrowpdownStore')}}" method="post">
                    @csrf
                  ...
                  <input type="hidden" name="field_id" value="{{@$dynamic_field->id}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="">Option Name</label>
                            <input class="form-control" type="text" name="option_value" placeholder="Enter Option Name">
                        </div>
