          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-br-primary rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Time</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1" id="clock"></p>
                  <span class="tx-11 tx-roboto tx-white-6">Now Today Time</span>
                </div>
              </div>
            </div>
          </div><!-- col-3 -->
